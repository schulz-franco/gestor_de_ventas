...
class Ui_interfaz_mas_informacion(object):
    def setupUi(self, interfaz_mas_informacion):
        ...
        interfaz_mas_informacion.resize(148, 116)
        interfaz_mas_informacion.setStyleSheet("border: none;")
        ...
        self.info_codigo.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.info_nombre.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.info_apellido.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.info_edad.setAlignment(QtCore.Qt.AlignCenter)
