...
"}")
        ...
        self.btn_facturar = QtWidgets.QPushButton(self.frame_13)
        self.btn_facturar.setMinimumSize(QtCore.QSize(0, 30))
        self.btn_facturar.setObjectName("btn_facturar")
        self.horizontalLayout_8.addWidget(self.btn_facturar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionVentas_3.setText(_translate("MainWindow", "Consultar"))
