...
"}")
        ...
        self.btn_agregar_carrito = QtWidgets.QPushButton(self.frame_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_4.addWidget(self.btn_agregar_carrito)
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tablaVentas.sizePolicy().hasHeightForWidth())
        self.tablaVentas.setSizePolicy(sizePolicy)
        self.tablaVentas.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContentsOnFirstShow)
        ...
        self.tablaVentas.setShowGrid(False)
        self.tablaVentas.setGridStyle(QtCore.Qt.DotLine)
        ...
        self.tablaVentas.horizontalHeader().setDefaultSectionSize(90)
        self.tablaVentas.horizontalHeader().setMinimumSectionSize(130)
        self.tablaVentas.horizontalHeader().setStretchLastSection(True)
        self.tablaVentas.verticalHeader().setDefaultSectionSize(23)
        self.horizontalLayout_2.addWidget(self.tablaVentas)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Cod. Empleado"))
        item = self.tablaVentas.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Importe"))
        item = self.tablaVentas.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Fecha de venta"))
