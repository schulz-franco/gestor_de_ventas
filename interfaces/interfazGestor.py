...
"}")
        ...
        self.barraBusqueda.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.btnBuscar1.setMinimumSize(QtCore.QSize(70, 32))
        self.btnBuscar1.setMaximumSize(QtCore.QSize(16777215, 32))
        ...
        self.btnBuscar1.setIcon(icon)
        self.btnBuscar1.setIconSize(QtCore.QSize(24, 24))
...
"}")
        ...
        self.btn_agregar_carrito = QtWidgets.QToolButton(self.frame_6)
        ...
        self.btn_agregar_carrito.setMinimumSize(QtCore.QSize(0, 32))
        self.btn_agregar_carrito.setMaximumSize(QtCore.QSize(16777215, 32))
        self.btn_agregar_carrito.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/assets/assets/anadir-a-la-cesta.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_agregar_carrito.setIcon(icon1)
        self.btn_agregar_carrito.setIconSize(QtCore.QSize(30, 30))
        self.btn_agregar_carrito.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        ...
        self.btnCancelar.setMinimumSize(QtCore.QSize(0, 32))
        self.btnCancelar.setMaximumSize(QtCore.QSize(16777215, 32))
        self.btnCancelar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/assets/assets/quitar-carrito.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnCancelar.setIcon(icon2)
        self.btnCancelar.setIconSize(QtCore.QSize(30, 30))
        self.btnCancelar.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.btnCancelar.setObjectName("btnCancelar")
        self.horizontalLayout_4.addWidget(self.btnCancelar)
        self.btn_facturar = QtWidgets.QToolButton(self.frame_6)
        self.btn_facturar.setMinimumSize(QtCore.QSize(0, 32))
        self.btn_facturar.setMaximumSize(QtCore.QSize(16777215, 32))
        self.btn_facturar.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/assets/assets/factura.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_facturar.setIcon(icon3)
        self.btn_facturar.setIconSize(QtCore.QSize(30, 30))
        self.btn_facturar.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        ...
        self.comboVendedor.setMinimumSize(QtCore.QSize(150, 30))
        ...
        self.btnCerrarVenta.setMinimumSize(QtCore.QSize(90, 32))
        self.btnCerrarVenta.setMaximumSize(QtCore.QSize(16777215, 32))
        self.btnCerrarVenta.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.btnCerrarVenta.setStyleSheet("")
        self.btnCerrarVenta.setIconSize(QtCore.QSize(30, 30))
        self.btnCerrarVenta.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
